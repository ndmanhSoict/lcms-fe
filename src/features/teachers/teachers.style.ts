...
const ROW_GRID = 'minmax(200px, 2fr) minmax(160px, 1.5fr) minmax(130px, 1fr) minmax(110px, 0.9fr) minmax(100px, 0.8fr) 100px';
...
export const TeacherRow = styled(Paper)(({ theme }) => ({
    display: 'grid',
...
export const TeacherAvatar = styled(Avatar)(({ theme }) => ({
