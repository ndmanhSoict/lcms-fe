...
import { createBranchSchema, type CreateBranchFormValues } from '../schemas/branch.schemas';
...
export function CreateBranchDialog({ open, onClose, onSuccess, onError }: Props) {
    const queryClient = useQueryClient();
    const { register, handleSubmit, reset, formState: { errors } } = useForm<CreateBranchFormValues>({
    ...
    const onSubmit = (data: CreateBranchFormValues) => {
        mutation.mutate({
            name: data.name,
